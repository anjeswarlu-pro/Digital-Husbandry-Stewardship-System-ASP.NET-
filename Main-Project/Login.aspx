<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Main_Project.Login" %>
            ...
            <div class="login-container">
                <div class="login-box">
                    ...
                    <div class="login-form">
                        ...
                        <asp:TextBox ID="TextBox1" runat="server" CssClass="login-input" placeholder="AID"></asp:TextBox><br />
                        <asp:TextBox ID="TextBox2" runat="server" TextMode="Password" CssClass="login-input" placeholder="Password"></asp:TextBox><br />
                        <asp:Button ID="Button1" runat="server" Text="Login" OnClick="btnLogin_Click" CssClass="login-button" />
                        <asp:Label ID="Label1" runat="server" Text="" CssClass="login-message"></asp:Label>
                    </div>
                </div>
                ...
                <div class="login-box">
                    ...
                    <div class="login-form">
                        <!-- Your login form content -->
                        <asp:TextBox ID="txtUsername" runat="server" CssClass="login-input" placeholder="UID"></asp:TextBox><br />
                        <asp:TextBox ID="txtPassword" runat="server" TextMode="Password" CssClass="login-input" placeholder="Password"></asp:TextBox><br />
                        <asp:Button ID="btnLogin" runat="server" Text="Login" OnClick="BtnLogin_Click" CssClass="login-button" />
                        <asp:Label ID="lblMessage" runat="server" Text="" CssClass="login-message"></asp:Label>
                    </div>
